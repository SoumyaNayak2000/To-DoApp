        ...
        <div className="max-w-3xl mx-auto mt-10 p-8">
          <div className="bg-white -m-6 p-3 sticky top-0">
            <div className="flex justify-center flex-col items-center">
              ...
              <h1 className="text-5xl md:text-7xl font-bold mb-5">Tooo - Dooo's</h1>
              <h2 className="text-xxl md:text-xl font-bold italic text-purple-700 subpixel-antialiased font-serif">Developed By Soumya Ranjan Nayak</h2>
            </div>
